export { ReactComponent as BackIcon } from '../assets/images/icon-back.svg';
export { ReactComponent as CloseIcon } from '../assets/images/icon-close.svg';
export { ReactComponent as HamburgerIcon } from '../assets/images/icon-hamburger.svg';
